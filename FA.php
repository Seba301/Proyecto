...
<body style="background-color:#000066;">
    ...
    <form font="verdana" style="position:absolute; width:500px; height:490px; left:450px; top:100px; background-color: white" action="/action_page.php">
      ...
      <center>
      <h4>Funcionario Administrativo</h4>
    </center>
      <div class="container">
        ...
        <button onclick="window.location.href='Inicio FA.php'" type="submit">Ingresar </button>
        <label>
      ...
      <div class="container" style="background-color:#f1f1f1">
        ...
        <span class="psw">Olvidaste<a href="/recuperar_contraseña.php">Tu Contraseña?</a></span>
      </div>
    </form>
