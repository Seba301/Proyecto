...
<head>
    ...
    <script>
      ...
      if(codigo == null || codigo.length == 0 || /^\s+$/.test(codigo)){
        alert('ERROR: El campo código tiene que ser completado para enviar');
        return false;
      }
      if(repuestos== null || repuestos.length == 0 || /^\s+$/.test(repuestos)){
        alert('ERROR: El campo repuestos  asociado no debe ir vacío o lleno de solamente espacios en blanco');
        return false;
      }
...
<font face="Verdana">
    <h1 style="position: absolute; right: 500px"> Orden de compra </h1>
...
<tr>
  <td>Repuestos:</td>
  <td><textarea type="text" name="repuestos" id="repuestos"></textarea>
</tr>
<tr>
  <td>Cantidad:</td>
  <td><textarea type="text" name="cantidad" id="cantidad"></textarea> 
</tr>
<tr>
    <td>Nombre del proveedor:</td>
    <td><textarea type="text" name="nombre" id="nombre"></textarea>
  </tr>
<input style="position:absolute; left:800px; top:900px;" type="submit" value="Enviar">
</form>
</table>
</font>
