...
<body>
  <font face="Verdana" size="2" >   
    ...
    <h1 style="position:absolute; left:540px; top:490px" >INGRESA RUT DEL CLIENTE</h1>

    <form class="example" action="/action_page.php"  style="position:absolute; left:600px; top:550px" style="margin:auto;max-width:300px" >
