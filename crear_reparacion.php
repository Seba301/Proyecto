...
<font face="Verdana">
    <h1 style="position: absolute; right: 500px">Diagnostico</h1>
<form action="" onsubmit="return validarFormulario()">
  <table style="position: absolute; right: 500px; top: 250px">
<tr>
  <td>Horas Hombre:</td>
  <td><input type="text" name="horas_hombre" id="horas_hombre"></td>
...
<a href="crear_presupuesto.php"><button style="position:absolute; left:1100px; top:900px;" class="button button1">Siguiente</button></a>
</body>
</html>