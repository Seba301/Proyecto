...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = data.usuario;
    cell4 = newRow.insertCell(16);
    cell4.innerHTML = data.contraseña;
    cell4 = newRow.insertCell(17);
    cell4.innerHTML = data.perfil;
    cell4 = newRow.insertCell(18);
...
function onEdit(td) {
    ...
    document.getElementById("sueldo").value = selectedRow.cells[14].innerHTML;
    document.getElementById("usuario").value = selectedRow.cells[15].innerHTML;
    document.getElementById("contraseña").value = selectedRow.cells[16].innerHTML;
    document.getElementById("perfil").value = selectedRow.cells[17].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[14].innerHTML = formData.sueldo;
    selectedRow.cells[15].innerHTML = formData.usuario;
    selectedRow.cells[16].innerHTML = formData.contraseña;
    selectedRow.cells[17].innerHTML = formData.perfil;
}
